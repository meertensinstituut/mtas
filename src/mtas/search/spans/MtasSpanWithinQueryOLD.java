...
public class MtasSpanWithinQueryOLD extends MtasSpanQuery {
  
  /** The base query. */
  private SpanWithinQuery baseQuery;

  public MtasSpanWithinQueryOLD(SpanQuery q1, SpanQuery q2) {
    super();
  ...
  public MtasSpanQuery rewrite(IndexReader reader) throws IOException {
    ...
    if(newBaseQuery!=baseQuery) {
      try {
        MtasSpanWithinQueryOLD clone = (MtasSpanWithinQueryOLD) this.clone();      
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    final MtasSpanWithinQueryOLD that = (MtasSpanWithinQueryOLD) obj;
