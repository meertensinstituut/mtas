...
public class MtasSpanNotQuery extends MtasSpanQuery {
  ...
  protected class SpanNotWeight extends MtasSpanWeight {
    ...
    public SpanNotWeight(MtasSpanNotQueryWeight w1, MtasSpanNotQueryWeight w2,
        IndexSearcher searcher, Map<Term, TermContext> termContexts)
        throws IOException {
      super(MtasSpanNotQuery.this, searcher, termContexts);
      this.w1 = w1;
      this.w2 = w2;
    }
    ...
    public MtasSpans getSpans(LeafReaderContext context, Postings requiredPostings)
      ...
      return new MtasSpanNotSpans(s1, s2);
    }
   ...
   */
  protected class MtasSpanNotQuerySpans {
     ...
     */
    public MtasSpanNotQuerySpans(Spans spans) {
